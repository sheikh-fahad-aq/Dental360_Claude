...
## 2026-08-25
- `360_Flask_Appointment/app/models.py` — be-data-model (Edit) [bc2e78a0]
- `360_Flask_Appointment/app/charting_routes.py` — be-charting (Edit) [bc2e78a0]
- `360_Flask_Appointment/app/appointment_notes_routes.py` — be-visit-lifecycle (Edit) [bc2e78a0]
- `360_Flask_Appointment/tests/test_chart_visit_link.py` — be-charting (Write) [bc2e78a0]
- `PMS_React/src/api/appointments.js` — fe-scheduling (Edit) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/visitFormat.js` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/useVisitList.js` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/SelectVisitModal.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/useVisitNotes.js` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/VisitWorklistTab.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/VisitNotesTab.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/VisitInfoTab.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/VisitPanel.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/ChartingSection.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/ChartingHeaderControls.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/notes/notesListing.js` — fe-patient-chart (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/notes/useAllPatientNotes.js` — fe-patient-chart (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/notes/NoteFilterChip.jsx` — fe-patient-chart (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/notes/NoteViewerDrawer.jsx` — fe-patient-chart (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/notes/NotesSection.jsx` — fe-patient-chart (Write) [bc2e78a0]
- `PMS_React/.claude/launch.json` — fe-platform (Write) [bc2e78a0]
- `360_Flask_Appointment/app/chart_session_scheduler.py` — be-charting (Write) [bc2e78a0]

## 2026-08-26
- `PMS_React/src/components/patient-detail/charting/visit/ChartingVisitRail.jsx` — fe-charting (Write) [bc2e78a0]
- `PMS_React/src/components/patient-detail/charting/visit/useVisitPlannedTreatment.js` — fe-charting (Write) [334d82f3]
- `PMS_React/src/components/patient-detail/charting/visit/VisitPicker.jsx` — fe-charting (Write) [334d82f3]
- `PMS_React/src/components/patient-detail/charting/visit/MoveToVisitModal.jsx` — fe-charting (Write) [334d82f3]
- `PMS_React/src/components/patient-detail/charting/visit/VisitPanelFooter.jsx` — fe-charting (Write) [334d82f3]
- `PMS_React/src/components/patient-detail/charting/visit/VisitPlanActions.jsx` — fe-charting (Write) [334d82f3]
- `PMS_React/src/components/ErrorBoundary.jsx` — fe-platform (Edit) [334d82f3]
- `PMS_React/src/components/patient-detail/charting/visit/VisitWorklistTab.jsx` — fe-charting (Edit) [334d82f3]
- `PMS_React/src/components/patient-detail/charting/visit/AddToVisitModal.jsx` — fe-charting (Write) [e8287e2e]

## 2026-08-27
- `PMS_React/src/components/patient-detail/charting/treatment-listing/procedureFields.js` — fe-charting (Write) [e8287e2e]
- `PMS_React/src/components/patient-detail/charting/treatment-listing/CompleteProcedureModal.jsx` — fe-charting (Write) [e8287e2e]

## 2026-08-31
- `PMS_React/src/components/scheduling/SendAppointmentNotificationModal.jsx` — fe-scheduling (Write) [7d2faebb]
- `PMS_React/.claude/launch.json` — fe-platform (Write) [7d2faebb]
- `360_Flask_Appointment/tests/test_appointment_notify.py` — be-charting (Write) [7d2faebb]
- `PMS_React/src/components/scheduling/appointmentNotificationTemplate.js` — fe-scheduling (Write) [7d2faebb]
- `PMS_React/src/components/patient-detail/charting/visit/ChartingVisitRail.jsx` — fe-charting (Write) [d02eff43]
- `PMS_React/scan_nav_effects.cjs` — fe-platform (Write) [d02eff43]
- `PMS_React/scan_nav_effects2.cjs` — fe-platform (Write) [d02eff43]
- `PMS_React/scan_nav_effects3.cjs` — fe-platform (Write) [d02eff43]

## 2026-09-01
- `PMS_React/scripts/generate-primary-teeth.mjs` — fe-reports-worklists (Write) [f04962c8]
- `PMS_React/scripts/generate-primary-teeth.mjs` — fe-reports-worklists (Edit) [f04962c8]
- `360_Flask_Appointment/app/models.py` — be-data-model (Edit) [f04962c8]
- `360_Flask_Appointment/tests/test_patient_dentition.py` — be-charting (Write) [f04962c8]
- `PMS_React/src/api/charting.js` — fe-charting (Edit) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/toothIdentity.js` — fe-charting (Write) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/chartingConstants.js` — fe-charting (Edit) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/chartProcedureMappers.js` — fe-charting (Edit) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/ToothChartContext.jsx` — fe-charting (Edit) [f04962c8]
- `PMS_React/src/utils/patientMappers.js` — fe-patient-chart (Edit) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/useChartDentition.js` — fe-charting (Write) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/ChartingContext.jsx` — fe-charting (Edit) [f04962c8]
- `PMS_React/src/pages/PatientDetail.jsx` — fe-patient-chart (Edit) [f04962c8]
- `PMS_React/src/components/patient-detail/charting/DentitionMenu.jsx` — fe-charting (Write) [f04962c8]
